...
| Módulo | Descrição |
|--------|-----------|
| [API](https://github.com/vizinho-virtual/vizinho-virtual-api) | API REST + WebSocket — Java 21 · Spring Boot 4 |
| [Web](https://github.com/vizinho-virtual/vizinho-virtual-web) | SPA — React 19 · TypeScript · Vite |
| [Mobile](https://github.com/vizinho-virtual/vizinho-virtual-mobile) | App — Expo 54 · React Native 0.81 |
| [Docs](https://github.com/vizinho-virtual/vizinho-virtual-docs) | Documentação histórica e material do TCC |
